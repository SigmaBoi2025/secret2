...
// Updated MemoryFlipGame.jsx with enhanced modal and overlay styling
// Please paste this into your MemoryFlipGame.jsx file
...
/* ★★★★★ NEW STYLING — MATCHES OTHER GAMES ★★★★★ */
const Overlay = styled.div`
  position: fixed;
  inset: 0;
  background: rgba(255, 180, 205, 0.45);
...
const Modal = styled.div`
  ...
  backdrop-filter: blur(16px);
  border: 2px solid rgba(255, 255, 255, 0.45);
  box-shadow: 0 10px 32px rgba(255, 100, 170, 0.35),
              inset 0 2px 0 rgba(255, 255, 255, 0.5);
  display: flex;
  flex-direction: column;
  align-items: center;
...
const CloseButton = styled.button`
  ...
  font-weight: 700;
  cursor: pointer;
  text-shadow: 0 0 6px rgba(255, 140, 180, 0.9),
               0 0 10px rgba(255, 120, 160, 0.7);
  transition: transform 0.15s ease;
...
const CardFront = styled.div`
  ...
  background-position: center;
  border-radius: 10px;
  box-shadow: 0 0 8px rgba(255, 150, 200, 0.65);
  transform: rotateY(0);
  transition: transform 0.4s ease;
`;
